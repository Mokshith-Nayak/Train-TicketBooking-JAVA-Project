...
public class Ticket {
    ...
    private LocalDate dateOfTravel;  // Use LocalDate instead of String
    private Train train;
    ...
    public LocalDate getDateOfTravel() {  // Use LocalDate
        return dateOfTravel;
    }

    public void setDateOfTravel(LocalDate dateOfTravel) {  // Use LocalDate
        this.dateOfTravel = dateOfTravel;
    }
